...
# 二维卷积
# x为输入：[batch, in_height, in_width, in_channels]
# w1为卷积核：[filter_height, filter_width, in_channels, out_channels]:[卷积核的高度，卷积核的宽度，图像通道数，卷积核个数]
...
with tf.gfile.FastGFile('./mode.pb', mode = 'wb') as f:
